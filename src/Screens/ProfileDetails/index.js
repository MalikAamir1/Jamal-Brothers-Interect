...
function ProfileDetails({navigation}) {
  ...
  console.log('UserData on profile details', UserData);
  // console.log('reducerdata on profile details', reducerData);

  useEffect(() => {
    setFirstName(
      UserData?.userdata?.additionalUserInfo?.profile
    ...
    setlastName(
      UserData?.userdata?.additionalUserInfo?.profile?.last_name ==
        undefined
        ? UserData?.userdata?.additionalUserInfo?.profile
            ?.family_name
        : UserData?.userdata?.additionalUserInfo?.profile
